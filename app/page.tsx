...
const guideCopy = {
  ...
  ja: { kicker: "OFFICIAL PRODUCT GUIDE", title: "公式販売資料で\n商品を詳しく確認。", intro: "商品の特徴、サイズ、使い方、保管方法、よくある質問を公式画像で確認できます。", translationNote: "画像内の原文は韓国語です。拡大表示すると、選択した言語で校正済みの要約を確認できます。", labels: ["商品総合案内", "プレミアム品質", "サイズとおすすめ", "3ステップ使用法", "印刷・はがす・飾る", "よくある質問", "アイシングシート V.10"], open: "拡大表示", close: "閉じる", translatedHeading: "画像内テキストの校正訳", originalNote: "表示・認証に関する詳細は、最新の商品ラベルおよび公式販売情報をご確認ください。", cafeKicker: "CAFÉ & HOTEL", cafeTitle: "コーヒーやドリンクにも\nブランドを鮮やかに。", cafeText: "食用ロゴトッパーでカフェのシグネチャーメニュー、ホテルイベント、ブランドプロモーションを演出します。" },
  zh: { kicker: "OFFICIAL PRODUCT GUIDE", title: "通过官方销售资料\n详细了解产品。", intro: "查看产品特点、规格、使用方法、储存方式和常见问题。", translationNote: "图片原文为韩语。放大查看后，可阅读所选语言的校对版要点。", labels: ["完整产品指南", "优质品质", "规格与推荐", "三步使用方法", "打印、揭下、装饰", "常见问题", "糖霜纸 V.10"], open: "放大查看", close: "关闭", translatedHeading: "图片文案校对译文", originalNote: "产品标识和认证信息请以最新包装及官方销售资料为准。", cafeKicker: "CAFÉ & HOTEL", cafeTitle: "让咖啡和饮品也能\n清晰呈现品牌。", cafeText: "使用定制可食用标志装饰，打造咖啡馆招牌菜单、酒店活动与品牌推广。" },
};
