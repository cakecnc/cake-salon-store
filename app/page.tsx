...
const conversionCopy: Record<Lang, {
  ...
  ko: { purchase: "네이버 스마트스토어에서 구매하기", inquiry: "1:1 맞춤 제작 문의", currentPrice: "판매가", specs: "구성·규격", order: "주문 조건", productMeta: [["40,000원", "A4 · 25장 구성", "최소 주문 1팩"], ["6,840원부터", "A4 맞춤 프린팅", "주문 단위는 상품 옵션 기준"]], guideNote: "제품 특징과 규격, 사용법을 한눈에 확인하세요.", proofKicker: "VERIFIED PROOF", proofTitle: "확인 가능한 정보와\n실제 적용 사례만 담았습니다.", proofText: "케익살롱이 제공한 공식 제품 정보와 실제 제작 이미지를 기준으로 구성했습니다. 확인되지 않은 후기나 제휴사는 표시하지 않습니다. 판매가는 스마트스토어 옵션과 행사에 따라 변경될 수 있습니다." },
  en: { purchase: "Buy on Naver Smart Store", inquiry: "Request a Custom Quote", currentPrice: "Price", specs: "Pack & size", order: "Order terms", productMeta: [["KRW 40,000", "A4 · 25 sheets", "Minimum order: 1 pack"], ["From KRW 6,840", "A4 custom print", "Order unit follows store options"]], guideNote: "Review product features, sizes and directions at a glance.", proofKicker: "VERIFIED PROOF", proofTitle: "Only verified facts and\nreal applications.", proofText: "This section uses official Cake Salon product information and supplied production images. Prices may change depending on Smart Store options and promotions." },
